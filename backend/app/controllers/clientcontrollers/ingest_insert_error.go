...
// server fault, and the SDK retries. A mixed request that already enqueued
// other tables is retried whole — duplicates are acceptable under
// at-least-once ingest semantics. Everything else stays a 500.
