...
func (c *widgetGroupController) GetWithWidgets(ctx *gin.Context) {
	...
	widgets, err := repositories.WidgetGroupRepository.FindWidgetsByGroupWithStar(tx, id)
	if err != nil {
...
func (c *widgetGroupController) Delete(ctx *gin.Context) {
	...
	if err := repositories.WidgetGroupRepository.DeleteStarredByGroup(tx, id); err != nil {
