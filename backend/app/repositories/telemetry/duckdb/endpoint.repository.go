...
func (e *endpointRepository) InsertAsync(ctx context.Context, lines []models.Endpoint) error {
	...
	return withAppenderColumns(ctx, "endpoints_v2", strings.Split("id, project_id, endpoint, duration, recorded_at, status_code, body_size, client_ip, attributes, app_version, server_name, trace_id, span_id, parent_span_id, is_stream, is_root", ", "), func(appender *duckdb.Appender) {
