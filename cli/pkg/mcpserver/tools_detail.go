...
func (s *server) getTask(ctx context.Context, _ *mcp.CallToolRequest, in getTaskIn) (*mcp.CallToolResult, any, error) {
	...
	resp, err := s.cfg.Client.GetTask(ctx, projectID, in.ID, recordedAt)
	if err != nil {
...
func (s *server) getAiTrace(ctx context.Context, _ *mcp.CallToolRequest, in getAiTraceIn) (*mcp.CallToolResult, any, error) {
	projectID, err := s.project(in.ProjectID)
	if err != nil {
		return nil, nil, err
	}
	...
	resp, err := s.cfg.Client.GetAiTrace(ctx, projectID, in.ID, recordedAt)
	if err != nil {
		return nil, nil, s.apiErr(err)
	}
	return nil, resp, nil
...
func (s *server) getSession(ctx context.Context, _ *mcp.CallToolRequest, in getSessionIn) (*mcp.CallToolResult, any, error) {
	projectID, err := s.project(in.ProjectID)
	if err != nil {
		return nil, nil, err
	}
	...
	resp, err := s.cfg.Client.GetSession(ctx, projectID, in.ID, startedAt)
	if err != nil {
		return nil, nil, s.apiErr(err)
	}
	return nil, resp, nil
...
func (s *server) getTrace(ctx context.Context, _ *mcp.CallToolRequest, in getTraceIn) (*mcp.CallToolResult, any, error) {
	if err := validateUUID("id", in.ID); err != nil {
		return nil, nil, err
	}
	recordedAt, err := parseTimestamp("recorded_at", in.RecordedAt)
	...
	resp, err := s.cfg.Client.GetDistributedTrace(ctx, in.ID, recordedAt)
	if err != nil {
		return nil, nil, s.apiErr(err)
	}
	return nil, resp, nil
