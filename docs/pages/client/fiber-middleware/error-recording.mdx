# Fiber Error Recording

When an exception occurs during a request (panic, handler error, or status >= 500), you can control what additional request data is captured alongside the stack trace.
...
// Record everything
tracewayfiber.RecordingUrl | tracewayfiber.RecordingQuery | tracewayfiber.RecordingBody | tracewayfiber.RecordingHeader
```
