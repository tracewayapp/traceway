...
- **esbuild** has no debug ID support (and no plugin hook that allows injecting one); esbuild-built apps fall back to filename matching.

## Next Steps

- [Source Maps](/client/js-sdk/sourcemap-upload) — the upload CLI
- [Symbolication](/learn/symbolication-js) — the full resolution pipeline
