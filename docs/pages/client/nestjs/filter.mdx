...
import { TracewayModule, TracewayExceptionFilter } from "@traceway/nestjs";
...
For NestJS `HttpException` errors (4xx client errors), the filter:
...
@Get("crash")
crash() {
  // This gets captured to Traceway
  throw new Error("Something went wrong");
}

@Get("not-found")
notFound() {
  // This does NOT get captured (4xx error)
