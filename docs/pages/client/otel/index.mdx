...
- `503` with `Retry-After` means ingest is saturated, or this project already holds its share of the ingest slots (one project cannot take them all). Exporters retry this automatically.
