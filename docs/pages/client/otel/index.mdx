...
| **Max body size** | 10 MB **after decompression**. Gzip does not raise it |
...
| Large exports vanish and the exporter logs a 400 | The batch exceeded 10 MB after decompression, was truncated, and failed to parse | Lower the exporter's batch size |
