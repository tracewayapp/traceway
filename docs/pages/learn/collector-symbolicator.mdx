...
<Callout type="info">
  Use the latest tag of `github.com/tracewayapp/traceway/backend` (the
  processor ships in releases after `v1.5.2`), and keep the collector
  component versions aligned with each other as usual for OCB manifests.
</Callout>
