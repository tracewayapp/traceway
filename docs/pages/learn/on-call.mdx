...
That badge and that queue are per project. For pages across every project in the organization at once, use the organization's [On-Call page](/learn/organization-overview#on-call).
