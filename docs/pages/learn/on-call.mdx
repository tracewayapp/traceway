...
That badge and that queue are per project. For pages across every project in the organization at once, use the [Organization Overview](/learn/organization-overview).
