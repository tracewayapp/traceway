...
|---|---|---|
| `files` | yes | One or more Mach-O dSYM binaries. Repeatable to upload several at once. 200 MB per file, 250 MB and 100 files total per request (a larger body answers `413`, too many files `422`). |
