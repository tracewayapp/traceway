...
The same processor also auto-routes non-symbolic Dart AOT traces and stripped iOS/Swift traces to the [Dart](/symbolicator/dart) and [iOS](/symbolicator/ios) paths. The walkthrough below covers the JavaScript source-map workflow.
