<script lang="ts">
	...
	let {
		...
		authHeader,
		collectorConfig
	}: { endpoint: string; authHeader: string; collectorConfig: string } = $props();
</script>
