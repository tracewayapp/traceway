...
const tabs: Tab[] = [
  ...
  },
  {
    ...
    icon: Network,
    color: "var(--ok)",
    heading: "Search spans. Follow the whole request.",
    description:
      "Search OpenTelemetry spans by service, duration, status and attributes. Open a result to follow its trace across services, inspect the span waterfall and read logs carrying the same trace ID.",
    bullets: [
      "Span explorer with service and attribute filters",
      "One trace across services and accessible projects",
      "Original OTel trace IDs and parent relationships",
      "Correlated logs and span-level error context",
    ],
    href: "/product/traces",
  },
  {
