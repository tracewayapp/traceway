...
<img width="320" alt="New Channel dialog configured with the GitHub type, a personal access token, the repository owner and name, and the traceway label" src="/blog/auto-fix-loop/img1-github-channel.webp" />
...
<img width="320" alt="New Rule dialog with the New Issue rule type attached to the GitHub channel, ignore patterns, a 15 minute cooldown, and critical severity" src="/blog/auto-fix-loop/img2-github-rule.webp" />
...
_I'm building this in the open. Traceway is MIT-licensed and OpenTelemetry-native, and everything described here ships with it. If you wire this loop up and an agent fixes a real bug while you were asleep, I genuinely want to hear about it:_ [_dusan@tracewayapp.com_](mailto:dusan@tracewayapp.com)_._